...
// //Configurar informações que serão carregadas no modal (Card expandido)
...
// //Função para recuperar escolhas do usuário
// function getUserOption(SelectIndex) {
//     const select = document.getElementsByClassName('select')[SelectIndex];
//     const optionValue = select.options[select.electedIndex].value;
